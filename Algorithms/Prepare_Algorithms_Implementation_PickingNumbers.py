...
Example
    a=[1,1,2,2,4,4,5,5,5]
    There are two subarrays meeting the criterion: [1,1,2,2] and
...
Returns
    int: the length of the longest subarray that meets the
    criterion
Input Format
...
Explanation 0
    ...
    {4,3,3}. Each pair in the multiset has an absolute difference
    <=1 (i.e., |4-3|=1 and |3-3|=0), so we print the number of
...
Explanation 1
    ...
    difference <=1 (i.e.|1-2|=1, |1-1|==0, and |2-2|=0), so we
