...
Example
    arr=[1,3,5,7,9]
    The minimum sum is 1+3+5+7=16 and the maximum sum is 3+5+7+9=24. The function
    prints
    16 24
...
Sample Output
    10 14
Explanation
    The numbers are 1, 2, 3, 4, and 5. Calculate the following sums using four of the
    five integers:
...
void miniMaxSum(vector<int> arr) {
    long max = LONG_MIN, min = LONG_MAX, total = 0;
