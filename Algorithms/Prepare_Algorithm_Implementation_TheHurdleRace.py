...
are of varying heights, and the characters have a maximum height they can jump. There
is a magic potion they can take that will increase their maximum jump height by 1 unit
...
Example
    height=[1,2,3,3,2]
    k=1
    The character can jump 1 unit high initially and must take 3-1=2 doses of potion
...
Sample Output 1
    0
Explanation 1
    Dan's character can jump a maximum of k7 units, which is enough to cross all the
    hurdles:
        image
